...
namespace Workspace.__WsNamespacePrefix.__WsAssemblyName.BusinessRule.DashboardExtender.DDM_LoadDB
{
    public class MainClass
    {
        ...
        private string MainMenuParam = "BL_DDM_AppMenu";
        private string showHideIVName = "IV_DDM_App_ShowHide_MenuBtn";
        private string showBtnVisibleName = "IV_DDM_App_DispShow_MenuBtn";
        private string hideBtnVisibleName = "IV_DDM_App_DispHide_MenuBtn";
        private string menuWidthIV = "IV_DDM_App_MenuWidth";
        #endregion
